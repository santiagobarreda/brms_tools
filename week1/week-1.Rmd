...
all_data_model = readRDS ("all_data_model.RDS")
speaker_average_model = readRDS ("speaker_average_model.RDS")
```
...
```{r}
## read data from pre-fit model
multilevel_model = readRDS ("multilevel_model.RDS")
```
```{r}
