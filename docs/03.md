...
<div class="figure">
<img src="03_files/figure-html/unnamed-chunk-27-1.png" alt="Random speaker intercept estimates provided by brm. Note that we get point estimates and credible intervals." width="672" />
<p class="caption">(\#fig:unnamed-chunk-27)Random speaker intercept estimates provided by brm. Note that we get point estimates and credible intervals.</p>
</div>
...
<div class="figure">
<img src="03_files/figure-html/unnamed-chunk-29-1.png" alt="Random speaker intercept estimates provided by lmer. Note that we get only point estimates, no credible intervals." width="672" />
<p class="caption">(\#fig:unnamed-chunk-29)Random speaker intercept estimates provided by lmer. Note that we get only point estimates, no credible intervals.</p>
</div>
...
<div class="figure">
<img src="03_files/figure-html/unnamed-chunk-30-1.png" alt="Comparison of speaker intercept estimates provided by brm and lmer. Diagonal red line indicates values where y = x." width="672" />
<p class="caption">(\#fig:unnamed-chunk-30)Comparison of speaker intercept estimates provided by brm and lmer. Diagonal red line indicates values where y = x.</p>
</div>
