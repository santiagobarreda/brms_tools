...
To be perfectly honest you won't really use single-group designs very much in your work. Research questions in linguistics most often require linguists to compara at least two conditions or groups of data. In a sense, even a single-group question carries an implicit comparison within it. Caring that the value of some variable is one value sort of pressuposes that there is some other potential values of interest that is it not. What I mean by this is that simply saying "the mean f0 produced by adult women from Michigan is 220 Hz" indicates that the mean is *not* 200 Hz, and it is *not* 240 Hz, and thereby makes at least an implicit comparison. 


For a model with this structure, it doesn't matter if different people are in either group or not, and you can have some people in both groups too! 
also mention that group is just what you can a group.
...
## 1 (Intercept+adult1) = 0   220.39      2.85   214.67   225.88         NA
##   Post.Prob Star
## 1        NA    *
## ---
...
## 1 (Intercept) = 0   220.47      2.88   214.73      226         NA        NA
##   Star
## 1    *
## ---
## 'CI': 90%-CI for one-sided and 95%-CI for two-sided hypotheses.
...
## Hypothesis Tests for class b:
##               Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio
## 1        (Intercept) = 0   229.29      2.66   224.18   234.39         NA
## 2 (Intercept+adult1) = 0   220.39      2.85   214.67   225.88         NA
## 3 (Intercept-adult1) = 0   238.20      4.53   229.29   247.16         NA
##   Post.Prob Star
## 1        NA    *
## 2        NA    *
## 3        NA    *
...
## Hypothesis Tests for class b:
##                 Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio
## 1 (Intercept+adultc... = 0   229.35      2.70   224.04   234.51         NA
## 2          (Intercept) = 0   220.47      2.88   214.73   226.00         NA
## 3 (Intercept+adultc... = 0   238.22      4.45   229.70   246.99         NA
##   Post.Prob Star
## 1        NA    *
## 2        NA    *
## 3        NA    *
