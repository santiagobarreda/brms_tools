...
In terms of model design concepts, last chapter introduced the notion of *factors* and *coding*. In this chapter, we're going to discuss how to build models with multiple factors, and how to allow these models to *interact* in our models. 
