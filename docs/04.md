...
##   effect1__ estimate__     se__  lower__  upper__
## 1     adult   220.5119 2.950740 214.4826 226.4404
## 2     child   238.4238 4.839866 229.0110 247.6442

# gender effect (average for females vs males)
model_effects[[2]][,-c(1:5)]
##   effect1__ estimate__     se__  lower__  upper__
## 1    female   220.5119 2.950740 214.4826 226.4404
## 2      male   131.3351 3.191314 124.9046 137.3878

# recreated group means for w, m, g, b
model_effects[[3]][,-c(1:5)]
##   effect1__ effect2__ estimate__     se__  lower__  upper__
## 1     adult    female   220.5119 2.950740 214.4826 226.4404
## 2     adult      male   131.3351 3.191314 124.9046 137.3878
## 3     child    female   238.4238 4.839866 229.0110 247.6442
## 4     child      male   236.0509 4.175498 227.9085 244.4526
```
...
##        b        g        m        w 
## 236.0741 238.3509 131.2185 220.4010
brms::hypothesis (model_interaction, c(
                "Intercept = 0",
                "Intercept + -adult1 + -gender1 +  adult1:gender1 = 0",
                "Intercept + -adult1 +  gender1 + -adult1:gender1 = 0",
                "Intercept +  adult1 + -gender1 + -adult1:gender1 = 0",
...
group_effects = 
  brms::hypothesis (model_interaction, hypothesis = 
...
##    Estimate Est.Error   CI.Lower  CI.Upper
## 1  29.49602  3.572487  22.395865  36.55756
## 2  31.84266  3.942479  24.140857  39.59088
## 3 -75.28023  2.941089 -81.039480 -69.48480
## 4  13.94155  2.891922   8.309273  19.62493
```
