...
\caption{Data from a single group of subjects (S) divided according to a single grouping factor A.}(\#fig:F4-designfig)
\end{figure}
...
![(\#fig:F4-datacomparison)(left) Comparison of the four groups (middle) Comparison of productions based on whether the speaker is an adult (right) Comparison of all productions based on whether the speaker is male.](04_files/figure-latex/F4-datacomparison-1.pdf) 
...
![(\#fig:F4-speakerboxplots)(left) Boxplots presenting each speaker's production of f0 for boys (red), girls (yellow), men (green), and women (teal). (right) Densities of the overall distributions for each group.](04_files/figure-latex/F4-speakerboxplots-1.pdf) 
...
\caption{Data from four groups of subjects (S) divided according to a two grouping factors A and B.}(\#fig:F4-designfig2)
\end{figure}
...
head (y_pred)
##      Estimate Est.Error     Q2.5    Q97.5
## [1,] 243.8459  12.37176 218.4376 268.0974
## [2,] 278.1639  12.38849 254.1651 302.3633
## [3,] 207.2018  12.27608 183.3759 230.9995
## [4,] 246.7387  12.33436 222.0655 270.5234
## [5,] 218.4364  12.59237 193.8152 243.1938
## [6,] 300.8292  12.70055 275.9963 325.4610
```
...
![(\#fig:F4-postpred1)(left) Posterior predicted f0 for the model with speaker random effects. (right) Posterior predicted f0 for the model without speaker random effects](04_files/figure-latex/F4-postpred1-1.pdf) 
...
![(\#fig:F4-interactionplot)Plots showing different ways to consider our f0 data.](04_files/figure-latex/F4-interactionplot-1.pdf) 
...
![(\#fig:interactionplot3)Interaction plots showing comparing our f0 data to different posterior predictions, with and without RE (random effects).](04_files/figure-latex/interactionplot3-1.pdf) 
...
\begin{figure}
\includegraphics[width=1\linewidth]{./images/interactionplot} \caption{An interaction plot built up from its individual components.}(\#fig:F4-interactionfig)
\end{figure}
...
![(\#fig:interactionplot2)Interaction plots showing comparing our f0 data to posterior predictions, with and without interaction terms (neither contains Random Effects).](04_files/figure-latex/interactionplot2-1.pdf) 
...
![(\#fig:brmsplot)Horizontal and vertical plots of our fixed effects. Points indicate posterior means and lines indicate span of 95% credible intervals of the posterior distribution of the parameter.](04_files/figure-latex/brmsplot-1.pdf) 
