...
\FunctionTok{mean}\NormalTok{ (means)}
\DocumentationTok{\#\# [1] 206.51}

\CommentTok{\# group means}
\NormalTok{means}
\DocumentationTok{\#\#      b      g      m      w }
\DocumentationTok{\#\# 236.07 238.35 131.22 220.40}

\CommentTok{\# centered means}
\NormalTok{means }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{ (means)}
\DocumentationTok{\#\#       b       g       m       w }
\DocumentationTok{\#\#  29.563  31.840 {-}75.293  13.890}
...
\DocumentationTok{\#\#                      Hypothesis Estimate Est.Error CI.Lower CI.Upper}
\DocumentationTok{\#\# 1               (Intercept) = 0  206.486    1.9287 202.6697  210.213}
\DocumentationTok{\#\# 2                  (group1) = 0   29.532    3.5239  22.7831   36.645}
\DocumentationTok{\#\# 3                  (group2) = 0   31.878    3.9764  24.3510   39.684}
\DocumentationTok{\#\# 4                  (group3) = 0  {-}75.176    2.9037 {-}80.8886  {-}69.620}
\DocumentationTok{\#\# 5 ({-}(group1+group2+group3)) = 0   13.766    2.9346   7.9231   19.379}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#                         Hypothesis Estimate Est.Error CI.Lower CI.Upper}
\DocumentationTok{\#\# 1                  (Intercept) = 0   209.13    2.6607   203.95   214.38}
\DocumentationTok{\#\# 2 (Intercept+{-}adult1+{-}gender1) = 0   211.59    4.8403   202.16   221.42}
\DocumentationTok{\#\# 3  (Intercept+{-}adult1+gender1) = 0   272.57    5.3907   262.09   283.07}
\DocumentationTok{\#\# 4  (Intercept+adult1+{-}gender1) = 0   145.69    4.0108   137.79   153.42}
\DocumentationTok{\#\# 5   (Intercept+adult1+gender1) = 0   206.68    3.8145   199.20   214.21}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 1                                 (Intercept) = 0   206.56    1.9131   202.78}
\DocumentationTok{\#\# 2 (Intercept+{-}adult1+{-}gender1+adult1:gender1) = 0   236.06    4.1908   227.91}
\DocumentationTok{\#\# 3 (Intercept+{-}adult1+gender1+{-}adult1:gender1) = 0   238.40    4.8091   229.01}
\DocumentationTok{\#\# 4 (Intercept+adult1+{-}gender1+{-}adult1:gender1) = 0   131.28    3.1841   124.90}
\DocumentationTok{\#\# 5   (Intercept+adult1+gender1+adult1:gender1) = 0   220.50    3.0216   214.48}
\DocumentationTok{\#\#   CI.Upper}
\DocumentationTok{\#\# 1   210.27}
\DocumentationTok{\#\# 2   244.45}
\DocumentationTok{\#\# 3   247.64}
\DocumentationTok{\#\# 4   137.39}
\DocumentationTok{\#\# 5   226.44}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{plot.interaction}\NormalTok{ (h95}\SpecialCharTok{$}\NormalTok{gender, h95}\SpecialCharTok{$}\NormalTok{adult, h95}\SpecialCharTok{$}\NormalTok{f0, }\AttributeTok{col=}\DecValTok{3}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{130}\NormalTok{,}\DecValTok{280}\NormalTok{),}\AttributeTok{lwd=}\DecValTok{3}\NormalTok{,}
                  \AttributeTok{type=}\StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{,}\AttributeTok{pch=}\FunctionTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{,}\DecValTok{17}\NormalTok{),}\AttributeTok{cex=}\FloatTok{1.5}\NormalTok{,}\AttributeTok{main=}\StringTok{"Data"}\NormalTok{,}\AttributeTok{legend =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}f0 (Hz)\textquotesingle{}}\NormalTok{)}

\FunctionTok{plot.interaction}\NormalTok{ (h95}\SpecialCharTok{$}\NormalTok{gender, h95}\SpecialCharTok{$}\NormalTok{adult, y\_pred\_no\_re[,}\DecValTok{1}\NormalTok{],}\AttributeTok{col=}\DecValTok{3}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, }\AttributeTok{lwd=}\DecValTok{3}\NormalTok{,}
                  \AttributeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{, }\AttributeTok{pch =} \FunctionTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{,}\DecValTok{17}\NormalTok{), }\AttributeTok{cex =} \FloatTok{1.5}\NormalTok{, }\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{130}\NormalTok{,}\DecValTok{280}\NormalTok{),}
                  \AttributeTok{main=}\StringTok{"No Int. no RE"}\NormalTok{, }\AttributeTok{legend =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}f0 (Hz)\textquotesingle{}}\NormalTok{)}
...
\FunctionTok{plot.interaction}\NormalTok{ (h95}\SpecialCharTok{$}\NormalTok{gender, h95}\SpecialCharTok{$}\NormalTok{adult, y\_pred\_no\_re\_int[,}\DecValTok{1}\NormalTok{],}\AttributeTok{col=}\DecValTok{3}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, }\AttributeTok{lwd=}\DecValTok{3}\NormalTok{,}
                  \AttributeTok{type =} \StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{, }\AttributeTok{pch =} \FunctionTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{,}\DecValTok{17}\NormalTok{), }\AttributeTok{cex =} \FloatTok{1.5}\NormalTok{, }\AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{130}\NormalTok{,}\DecValTok{280}\NormalTok{),}
                  \AttributeTok{main=}\StringTok{"With Int. no RE"}\NormalTok{, }\AttributeTok{leg.x=}\FloatTok{1.8}\NormalTok{,}\AttributeTok{leg.y=}\DecValTok{270}\NormalTok{, }\AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(.}\DecValTok{95}\NormalTok{,}\FloatTok{2.3}\NormalTok{), }\AttributeTok{ylab =} \StringTok{\textquotesingle{}f0 (Hz)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{06_files/figure-latex/unnamed-chunk-13-1.pdf}
