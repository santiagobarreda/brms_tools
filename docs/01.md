...
![(\#fig:initialplot)(left) Plot of values in the order they appear in the original data. (right) Observations ordered by increasing value.](01_files/figure-latex/initialplot-1.pdf) 
...
\caption{Different ways to consider our distribution of f0 values.}(\#fig:F1-distributioncomparison)
\end{figure}
...
![(\#fig:F1-twohists1)(left) A histogram of our f0 data showing counts in each bin. (right) A histogram of our f0 data showing densities.](01_files/figure-latex/F1-twohists1-1.pdf) 
...
![(\#fig:F1-twohists2)The counts have been doubled relative to above.](01_files/figure-latex/F1-twohists2-1.pdf) 
...
![(\#fig:theoretical)A comparison of the data distribution with a theoretical normal distribution.](01_files/figure-latex/theoretical-1.pdf) 
...
![(\#fig:F1-prediction)The read area relects the distribution of outcomes that satisfy f0 < 175 Hz.](01_files/figure-latex/F1-prediction-1.pdf) 
...
&nbsp;
![(\#fig:F1-likelihood1)(Left) The likelihood of the population mean given the blue points in the figure. (right) The probability of the points given an assumed mean of 175 Hz.](01_files/figure-latex/F1-likelihood1-1.pdf) 
&nbsp;
...
&nbsp;
![(\#fig:F1-likelihood2)(Left) The probability of the points given an assumed mean of 200 Hz. (right) The probability of the points given an assumed mean of 225 Hz.](01_files/figure-latex/F1-likelihood2-1.pdf) 
&nbsp;
...
![(\#fig:F1-likelihood)Likelihood of population mean given our data. Horizontal lines indicate intervals enclosing 95% of the distribution.](01_files/figure-latex/F1-likelihood-1.pdf) 
&nbsp;
...
![(\#fig:F1-errorhist)(left) Histogram of data. (right) Histogram of centered data, basically the error distribution.](01_files/figure-latex/F1-errorhist-1.pdf) 
...
![(\#fig:F1-allf0s)(left) Distribution of f0 across all speakers. (right) Densities of distributions of f0 for different speaker classes: boys (red), girls (green), men (blue) and women (cyan).](01_files/figure-latex/F1-allf0s-1.pdf) 
...
![(\#fig:F1-posterior)Demonstration of the effect of different types of priors and likelihoods on posterior distributions.](01_files/figure-latex/F1-posterior-1.pdf) 
...
![(\#fig:F1-mcmc)Demonstration of parameter estimation using a random walk, yielding a good approximation of analytically-derived values.](01_files/figure-latex/F1-mcmc-1.pdf) 
