...
<p class="caption">(\#fig:unnamed-chunk-20)Comparison of real and simulated f0 production data.</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-22)(top) Simulated error variation around the intercept. (middle) Simulated between-speaker variation, but no production error. (bottom) Simulated data containing both within and between-speaker variation in f0.</p>
</div>
