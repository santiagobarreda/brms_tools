...
In section (4) lmer and brm presents the model intercept. We see that the mean estimates and intervals provided around these means closely align. Finally, in section (5) brm presnts some boilerplate that will look almost the same every time you fit a model. 
