...
```{r F1-twohists1, fig.height = 3.5, fig.width = 8, fig.cap='(left) A histogram of our f0 data showing counts in each bin. (right) A histogram of our f0 data showing densities.'}
...
```{r F1-twohists2, fig.height = 3.5, fig.width = 8, fig.cap='The counts have been doubled relative to above.'}
par (mfrow = c(1,2), mar = c(4,4,1,1))
...
```{r theoretical, fig.height = 3.5, fig.width = 8, fig.cap='A comparison of the data distribution with a theoretical normal distribution.', echo = FALSE}
...
```{r F1-quantiles, fig.height = 3.5, fig.width = 8, fig.cap='Quantiles and standard deviations help understand the shape of a distribution.'}
par (mfrow = c(1,2), mar = c(4,4,1,1))
...
```{r F1-prediction, fig.height = 3.5, fig.width = 8, fig.cap='The read area relects the distribution of outcomes that satisfy f0 < 175 Hz.', echo = FALSE}
...
&nbsp;
```{r F1-likelihood1, echo = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The likelihood of the population mean given the blue points in the figure. (right) The probability of the points given an assumed mean of 175 Hz.', echo = FALSE}
...
&nbsp;
```{r F1-likelihood2, echo = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The probability of the points given an assumed mean of 200 Hz. (right) The probability of the points given an assumed mean of 225 Hz.', echo = FALSE}
...
```{r F1-likelihood, fig.height = 3.5, fig.width = 8, fig.cap='Likelihood of population mean given our data. Horizontal lines indicate intervals enclosing 95% of the distribution.', echo = FALSE}
...
```{r F1-errorhist, fig.height = 3.5,fig.width = 8, fig.cap = "(left) Histogram of data. (right) Histogram of centered data, basically the error distribution.", echo = FALSE}
...
```{r F1-allf0s, fig.height = 3.5, fig.width = 8, fig.cap='(left) Distribution of f0 across all speakers. (right) Densities of distributions of f0 for different speaker classes: boys (red), girls (green), men (blue) and women (cyan).', echo = FALSE}
...
```{r F1-posterior, echo = FALSE, fig.height = 5.5, fig.width = 8, fig.cap='Demonstration of the effect of different types of priors and likelihoods on posterior distributions.'}
...
```{r F1-mcmc, echo = FALSE, fig.height = 5, fig.width = 8, fig.cap='Demonstration of parameter estimation using a random walk, yielding a good approximation of analytically-derived values.'}
