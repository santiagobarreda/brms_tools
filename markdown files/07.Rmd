...
```{r, include = FALSE}
# basic data setup mostly for plotting
#################################################
# set up predictor variables in our model
...
females = h95[!(h95$group %in% c('m','b')),]
males = h95[(h95$group %in% c('m','b')),]
males$adult = as.numeric (males$pgroup == 'm' )
females$adult = as.numeric (females$pgroup == 'w' )

agg_males = aggregate (cbind ( pheight, padult, g0,g0_s, gbar) ~ speaker+group, 
                      data = males, FUN = mean)
agg_females = aggregate (cbind ( pheight, padult, g0,g0_s, gbar) ~ speaker+group, 
                      data = females, FUN = mean)

agg_males$group = factor(agg_males$group)
agg_females$group = factor(agg_females$group)
```
...
```{r F7-1, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Average perceived height for each speaker as a function of average f0. (middle) The same relationship as the left but only males are plotted. (right) Only females are plotted.", echo = FALSE}
...
```{r F7-4, fig.width = 8, fig.height = 3.5, fig.cap = "(left) A line relating some predictor to logits. (right) A sigmoid curve expressing the probability associated with each value along the line in the left. Horizontal lines are places every 0.1 probability units from 0.1 to 0.9 probability.", echo = FALSE}
...
```{r F7-5, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Line indicating linear relationship between f0 and the logit of the probability of an adult response. (middle) Same as the left but only males are plotted. (middle) Same as the middle but only females are plotted.", echo = FALSE}
...
```{r F7-6, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Curve indicating the relationship between f0 and the probability of an adult response. (middle) Same as the left but only males are plotted. (middle) Same as the middle but only females are plotted.", echo = FALSE, cache = TRUE}
...
```{r F7-7, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Line indicating linear relationship between f0 and the logit of the probability of an adult response. (middle) Same as the left but only males are plotted. (middle) Same as the middle but only females are plotted.", echo = FALSE}
...
```{r F7-8, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Line indicating linear relationship between f0 and the logit of the probability of an adult response. (middle) Same as the left but only males are plotted. (middle) Same as the middle but only females are plotted.", echo = FALSE}
...
```{r F7-9, fig.width = 8, fig.height = 3.5, fig.cap = "Diagonal lines indicate the relationship between perceived adultness and f0, overall (black), and for women (teal) and men (coral). Bold vertical lines indicate x-axis intercept (category boundary) for each line.", echo = FALSE}
...
In Figure \@ref(fig:F7-10) I present a final figure that might be the most useful to use if this work were being presented somewhere. It contains the data summarized as probabilities and the x-axis labeled with Hz, both of which help interpret the figure. 

```{r F7-10, fig.width = 8, fig.height = 3.5, fig.cap = "Curves indicate the relationship between the probability of perceived adultness and f0, overall (black), and for women (teal) and men (coral). Bold vertical lines indicate category boundaries suggested by each line.", echo = FALSE}
