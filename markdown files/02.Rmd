...
```{r F2-1, fig.width = 8, fig.height = 3.5, fig.cap = "(left) Individual samples from posterior of mean f0 parameter. (right) a histogram of the same samples.", echo = FALSE}
...
```{r F2-2, fig.height = 6, fig.width = 8, fig.cap = "(top) Boxplot of overall distribution. (bottom) Speaker-specific boxplot of our f0 data.", echo = FALSE}
...
```{r F2-3, fig.height = 5, fig.width = 8, fig.cap = "(top left) All the f0 data (top right) A boxplot of the same data. (bottom left) Speaker-specific boxplots, with a vertical line for speaker 107. (bottom right) The histogram of data produced by speaker 107.", echo = FALSE}
...
```{r F2-4, fig.height = 3.5, fig.width = 8, fig.cap = "Speaker-specific boxplots for the f0 data.", echo = FALSE}
...
# intercepts. This is the between speaker variation in our model. See how it 
# is similar to the sd of the actual speaker means.
sd (speaker_means$f0)
...
```{r F2-5, fig.height = 3.5, fig.width = 8, fig.cap = "Speaker-specific boxplots for the f0 data.", echo = FALSE}
...
```{r F2-6, fig.height = 3.5, fig.width = 8, echo = FALSE, fig.cap = "TBD"}
...
```{r F2-7, fig.height = 3.5, fig.width = 8, fig.cap = "Speaker-specific boxplots for the f0 data.", echo = FALSE}
...
```{r F2-8, echo = FALSE, fig.width = 7, fig.height = 6, fig.cap = "Comparison of real and simulated f0 production data."}
...
```{r F2-9, fig.width = 7, fig.height = 6, fig.cap="(top) Simulated error variation around the intercept. (middle) Simulated between-speaker variation, but no production error. (bottom) Simulated data containing both within and between-speaker variation in f0.", echo = FALSE,fig.align = 'center'}
