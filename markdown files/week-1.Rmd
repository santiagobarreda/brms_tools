...
```{r initialplot, fig.height = 3.5, fig.width = 8, fig.cap='(left) Plot of values in the order they appear in the original data. (right) Observations ordered by increasing value.'}
...
```{r distributioncomparison, fig.height = 6, fig.width = 6, fig.cap='Different ways to consider our distribution of f0 values.'}
...
```{r twohists1, fig.height = 3.5, fig.width = 8, fig.cap='(left) A histogram of our f0 data showing counts in each bin. (right) A histogram of our f0 data showing densities.'}
...
```{r twohists2, fig.height = 3.5, fig.width = 8, fig.cap='The counts have been doubled relative to above.'}
par (mfrow = c(1,2), mar = c(4,4,1,1))
...
```{r theoretical, fig.height = 3.5, fig.width = 8, fig.cap='A comparison of the data distribution with a theoretical normal distribution.'}
...
```{r quantiles, fig.height = 3.5, fig.width = 8, fig.cap='Quantiles and standard deviations help understand the shape of a distribution.'}
par (mfrow = c(1,2), mar = c(4,4,1,1))
...
```{r prediction, fig.height = 3.5, fig.width = 8, fig.cap='The read area relects the distribution of outcomes that satisfy f0 < 175 Hz.'}
par (mfrow = c(1,1), mar = c(4,4,1,1))
hist (f0, freq = FALSE, main = "", breaks = 20, col = deepgreen)
...
&nbsp;
```{r likelihood1, echo = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The likelihood of the population mean given the blue points in the figure. (right) The probability of the points given an assumed mean of 175 Hz.'}
...
&nbsp;
```{r likelihood2, echo = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The probability of the points given an assumed mean of 200 Hz. (right) The probability of the points given an assumed mean of 225 Hz.'}
...
```{r likelihood, fig.height = 3.5, fig.width = 8, fig.cap='Likelihood of population mean given our data. Horizontal lines indicate intervals enclosing 95% of the distribution.'}
par (mfrow =c(1,1), mar = c(4,4,1,1))
...
```{r errorhist, fig.height = 3.5,fig.width = 8, fig.cap = "(left) Histogram of data. (right) Histogram of centered data, basically the error distribution."}
par (mfrow =c(1,2), mar = c(4,4,1,1))
...
```{r allf0s, fig.height = 3.5, fig.width = 8, fig.cap='(left) Distribution of f0 across all speakers. (right) Densities of distributions of f0 for different speaker classes: boys (red), girls (green), men (blue) and women (cyan).'}
par (mfrow =c(1,2), mar = c(4,4,1,1))
...
```{r posterior, echo = FALSE, fig.height = 5.5, fig.width = 8, fig.cap='Demonstration of the effect of different types of priors and likelihoods on posterior distributions.'}
x = seq (150, 301, .1)
...
```{r mcmc, echo = FALSE, fig.height = 5, fig.width = 8, fig.cap='Demonstration of parameter estimation using a random walk, yielding a good approximation of analytically-derived values.'}
set.seed(1)
...
```{r, eval = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The likelihood of the population mean given the blue points in the figure. (right) The probability of the points given an assumed mean of 175 Hz.'}
x = f0[1:10]   ## tiny sub sample for example
par (mfrow = c(1,2), mar = c(4,4,1,1))
plot (x,rep(0,10), ylim = c(0,.08), pch=16,col=4, xlim = c(150,300), 
      ylab='Density', main = 'Likelihood of mean',xlab='f0',cex.main=.8)
...
```{r, eval = FALSE, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The probability of the points given an assumed mean of 200 Hz. (right) The probability of the points given an assumed mean of 225 Hz.'}
x = f0[1:10]   ## tiny sub sample for exampls
par (mfrow = c(1,2), mar = c(4,4,1,1))
plot (x,rep(0,10), ylim = c(0,.022), pch=16,col=4,xlim= c(150,300),cex.main=.8, 
      ylab='Density', main = "mean = 200",xlab='f0')
...
```{r, fig.height = 7, eval = FALSE,fig.width = 8}
x = seq (150, 301, .1)
par (mfrow = c(4,1))
