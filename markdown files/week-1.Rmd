...
```{r initialplot, fig.height = 3.5, fig.width = 8, fig.cap='Initial plot of values.'}
...
```{r distributioncomparison, fig.height = 6, fig.width = 6, fig.cap='Different ways to consider a distribution'}
...
```{r twohists1, fig.height = 3.5, fig.width = 8, fig.cap='A comarison of two histograms'}
...
```{r likelihood1, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The likelihood of the population mean given the blue points in the figure. (right) The probability of the points given an assumed mean of 175 Hz.'}
...
```{r likelihood2, fig.height = 3.5, fig.width = 8, fig.cap='(Left) The probability of the points given an assumed mean of 200 Hz. (right) The probability of the points given an assumed mean of 225 Hz.'}
...
```{r posterior, fig.height = 5.5, collapse = TRUE, echo = FALSE,fig.width = 8, fig.caption = "Demonstration of the effect of different types of priors and likelihoods on posterior distributions."}
x = seq (150, 301, .1)
...
```{r mcmc, fig.height = 5, fig.width = 8, echo = FALSE, fig.caption = "Demonstration of parameter estimation using a random walk, yielding a good approximation of analytically-derived values."}
set.seed(1)
...
plot (samples_1)
hist (samples_1[-(1:250)], freq = FALSE, ylim = c(0,4.5), main="",col=skyblue)
x = seq (9.7,10.5,.001)
...
```{r, fig.height = 3.5, fig.width = 6, eval = FALSE,fig.width = 8}
set.seed(1)
## make a random sample of data
data_1 = rnorm (100,10,1)
## collect samples from the likelihood of the mean
