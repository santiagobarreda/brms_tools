...
devtools::source_url("https://raw.githubusercontent.com/santiagobarreda/stats-class/master/data/functions.R")
```
...
boxplot (f0 ~ uspeaker, data=females, col = colors, xla='f0')
abline (h = c(220,229,238), lwd = 4, col = 1)
abline (h = c(220,229,238), lwd = 3, col = c(coral,1,teal))
boxplot (f0 ~ uspeaker, data=females, col = colors,add = TRUE)
...
plot (density (females$f0[females$adult=="child"]), lwd = 3, col = teal, 
      ...
      type = 'l', main = '')
abline (v = c(220,229,238), lwd = 4, col = 1)
...
lines (density (females$f0), lwd = 3, col = 1)
