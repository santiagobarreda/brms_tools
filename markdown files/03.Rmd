...
```{r F3-boxplots, fig.height = 3.5, fig.width=8, fig.cap = "Boxplots comparing productions of f0 for different groupings of talkers.", echo = FALSE}
...
```{r F3-boxplots-density, fig.height = 4, fig.width=8, fig.cap = "Comparison of f0 productions by individual girls (cyan) and women (red). Densities compare whole distributions.", echo = FALSE}
...
```{r contrast-figure, echo = FALSE, out.width = "100%", fig.cap = "Artists rendition of contrast and treatment coding differences for our data"}
...
```
```{r, include = FALSE}
model_sum_coding = readRDS ('../../models/3_model_sum_coding.RDS')
```
```{r, collapse = TRUE}
# inspect model
model_sum_coding
...
```{r F3-sample-boxplots, fig.height = 4, fig.width = 8, fig.cap = "Comparison of histogram and trace plots of samples of selected parameters.", echo = FALSE}
...
```{r F3-boxplots-redux, fig.height = 4, fig.width=8, echo = FALSE, fig.cap="Productions of f0 by individual girls (cyan) and adult women (red)."}
...
speaker_effects = brms::ranef (model_sum_coding)$uspeaker[,,"Intercept"]
...
```{r brm-random-effects, fig.height = 3.5, fig.width = 8, fig.cap="Posterior estimates of speaker 'random intercepts for girls (cyan) and women (red). Points indicate means, bars indicate 95% credible intervals."}
par (mfrow = c(1,1), mar = c(4,4,1,1))
...
```{r brm-boxplot-comparison, fig.height = 3.5, fig.width = 8, fig.cap="Comarisons of random speaker effects to the distribution of productions for the same speakers, for girls (cyan) and women (red)."}
...
```{r F3-final-analysis, fig.height = 6, fig.width=8, echo = FALSE, fig.cap = "(top) Speaker boxplots for f0. Horizontal lines indicate the averages for girls (cyan) and women (red). (bottom) Densities of overall distributions for girls, and women. ", echo = FALSE}
...
```{r F3-simulated, echo = FALSE, fig.width = 7, fig.height = 4, fig.cap = "Comparison of real and simulated f0 production data for girls (cyan) and women (red)."}
...
```{r F3-sim-incomplete-1, fig.width = 7, fig.height = 6, fig.cap="(top) Simulated error variation around the intercept. (middle) Simulated variation according to adultness, but no production error or speaker differences. (bottom) Simulated between-speaker variation, but no production error or adultness effects.", echo = FALSE}
...
```{r, fig.width=7, fig.height=3.5, fig.cap="Random speaker intercept estimates provided by brm. Note that we get point estimates and credible intervals."}
...
brmplot (brms_ranefs, xaxt='n',labels = "", ylab="Speaker Effect (Hz)")
```
...
```{r, fig.width=7, fig.height=3.5, fig.cap="Random speaker intercept estimates provided by lmer. Note that we get only point estimates, no credible intervals."}
...
par(mfrow = c(1,1), mar = c(1,4.5,1,1))
plot (lmer_ranefs[,1],pch=16,cex=1.5, xaxt='n',xlab='',
...
```{r, fig.width=7, fig.height=3.5, fig.cap="Comparison of speaker intercept estimates provided by brm and lmer. Diagonal red line indicates values where y = x."}

################################################################################
### Figure 3.14
################################################################################

par(mfrow = c(1,1), mar = c(4.51,4.5,1,1))
